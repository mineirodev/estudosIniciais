...
let lingProg = prompt(' Qual a linguagem de programação que você mais gosta?');
console.log(`A resposta é ${lingProg}`);
...
let numero6 = parseInt(Math.random() * 10 + 1);
console.log(numero6);

//Use o Math.random para gerar um número inteiro entre 1 e 1000 e exiba esse número no console.
let numero7 = parseInt(Math.random() * 1000 + 1);
console.log(numero7);
